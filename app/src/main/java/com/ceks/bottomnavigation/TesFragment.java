...
public class TesFragment extends Fragment {
    ...
    private void initSettings(View view) {
        ...
        final SwitchCompat switchColored = view.findViewById(R.id.fragment_switch_colored);
        final SwitchCompat switchFiveItems = view.findViewById(R.id.fragment_switch_five_items);
        final SwitchCompat showHideBottomNavigation = view.findViewById(R.id.fragment_show_hide);
        final SwitchCompat showSelectedBackground = view.findViewById(R.id.fragment_selected_background);
        final Spinner spinnerTitleState = view.findViewById(R.id.fragment_title_state);
        final SwitchCompat switchTranslucentNavigation = view.findViewById(R.id.fragment_translucent_navigation);

        switchColored.setChecked(demoActivity.isBottomNavigationColored());
        switchFiveItems.setChecked(demoActivity.getBottomNavigationItems() == 5);
